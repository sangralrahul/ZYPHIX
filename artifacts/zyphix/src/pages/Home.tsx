...
const WLIST_ROLES = [
  { v: 'restaurant', e: '🍽️', l: 'Restaurant',      bg: '#FFF1F2', bd: '#FECDD3', ac: '#E11D48', tc: '#9F1239' },
  ...
  return (
    <div style={{ background: BG, minHeight: '100vh' }}>
      ...
      <a href="https://wa.me/919682394363" target="_blank" rel="noopener noreferrer"
        title="Chat with us"
        style={{ position: 'fixed', bottom: 28, right: 28, width: 54, height: 54, borderRadius: '50%', background: '#25D366', boxShadow: '0 6px 24px rgba(37,211,102,.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, textDecoration: 'none', transition: 'transform .2s, box-shadow .2s' }}
        onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.transform = 'scale(1.1)'; el.style.boxShadow = '0 10px 36px rgba(37,211,102,.7)'; }}
        onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.transform = 'scale(1)'; el.style.boxShadow = '0 6px 24px rgba(37,211,102,.55)'; }}>
